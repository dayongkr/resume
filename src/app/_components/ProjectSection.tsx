      ...
      >
        ...
        <List
          ...
          items={[
            ...
            {
              children:
                '깃허브 검색 서비스와 노션 차트를 활용해 어떤 함수가 많이 사용되는지 분석 및 시각화하고, 이를 메인테이너에게 공유하여 개발 외적으로도 도움이 되도록 했습니다.',
              link: {
                title: '해당 노션 페이지',
        ...
        <div className="md:col-span-2">
          ...
          <List
            ...
            items={[
              ...
              {
                children:
                  '성급한 개발으로 발생한 코드 중복을 줄이고, 통일성 없는 폴더 구조를 개선하기 위해 팀 토론을 주도하며, 응집도 높은 폴더 구조를 가지도록 개선안을 제안했습니다.',
                link: {
                  title: '토론 기록',
